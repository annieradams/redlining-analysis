---
title: "Environmental Factor's relationship with Redlined Communities"
author: "Annie Adams"
...
### Lets start by loading in the necessary packages and data.
...
Different environmental factors affect different censuses in
disproportionate ways. To visualize this, we will map wastewater
discharge.To see the upper values for this variables, we will select census block groups that are greater than the 95th percentile.
